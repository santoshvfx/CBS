...
public class SendFacilityAssignmentOrderTestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        SendFacilityAssignmentOrderRequestDto request = SendFacilityAssignmentOrderRequestDto.builder()
        ...
        given(documentationSpec)
                ...
                .filter(document("sendFacilityAssignmentOrder",
                ...
                .post(StringUtils.join(DEFAULT_SPRING_BOOT_BASE_URI,
                        BisApi.RM_BASE_URL,
                        "/",
                        RmController.SEND_FACILITY_ASSIGNMENT_ORDER_PATH_NAME))
                .then()
                .statusCode(500)
                .extract()
                .response()
