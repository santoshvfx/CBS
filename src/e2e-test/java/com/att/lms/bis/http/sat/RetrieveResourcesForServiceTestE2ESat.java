...
public class RetrieveResourcesForServiceTestE2ESat extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        String responseBody = given(documentationSpec)
                ...
                .filter(document("retrieveResourcesForService-sat",
