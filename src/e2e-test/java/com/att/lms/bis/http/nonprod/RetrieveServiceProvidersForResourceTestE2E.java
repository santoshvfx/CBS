...
public class RetrieveServiceProvidersForResourceTestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        String responseBody = given(documentationSpec)
                ...
                .filter(document("retrieveServiceProvidersForResource",
    ...
    private FieldDescriptor[] getRequestFieldDescriptor() {
        return new FieldDescriptor[] {
                ...
                subsectionWithPath("aResourceHandle").description("RM BIS Resource Handle"),
    ...
    private FieldDescriptor[] getResponseFieldDescriptor() {
        return new FieldDescriptor[] {
                ...
                subsectionWithPath("aServiceProvidersForServiceType").description("Service Provider for Service Types"),
        };
    }
}
