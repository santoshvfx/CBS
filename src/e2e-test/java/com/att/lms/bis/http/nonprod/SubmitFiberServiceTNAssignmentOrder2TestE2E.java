...
public class SubmitFiberServiceTNAssignmentOrder2TestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        SubmitFiberServiceTNAssignmentOrder2RequestDto request = SubmitFiberServiceTNAssignmentOrder2RequestDto.builder()
                ...
                .aSimplePortIndicator(new BooleanOpt())
        ...
        given(documentationSpec)
                ...
                .filter(document("submitFiberServiceTNAssignmentOrder2",
                ...
                .post(StringUtils.join(DEFAULT_SPRING_BOOT_BASE_URI,
                        BisApi.RM_BASE_URL,
                        "/",
                        RmController.SUBMIT_FIBER_SERVICE_TN_ASSIGNMENT_ORDER_2_PATH_NAME))
                .then()
                .statusCode(500)
                .extract()
                .response()
    ...
    private FieldDescriptor[] getRequestFieldDescriptor() {
        return new FieldDescriptor[] {
                ...
                subsectionWithPath("aSimplePortIndicator").description("Simple Port Indicator"),
