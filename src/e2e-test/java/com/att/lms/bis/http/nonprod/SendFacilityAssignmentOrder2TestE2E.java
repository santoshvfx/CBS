...
import com.att.lms.bis.dto.rm.SendFacilityAssignmentOrderRequestDto;
...
public class SendFacilityAssignmentOrder2TestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        SendFacilityAssignmentOrder2RequestDto request = SendFacilityAssignmentOrder2RequestDto.builder()
                ...
                .aTDMTelphoneNumber(new StringOpt())
        ...
        given(documentationSpec)
                ...
                .filter(document("sendFacilityAssignmentOrder2",
                ...
                .post(StringUtils.join(DEFAULT_SPRING_BOOT_BASE_URI,
                        BisApi.RM_BASE_URL,
                        "/",
                        RmController.SEND_FACILITY_ASSIGNMENT_ORDER_2_PATH_NAME))
                .then()
                .statusCode(500)
                .extract()
                .response()
    ...
    private FieldDescriptor[] getRequestFieldDescriptor() {
        return new FieldDescriptor[] {
                ...
                subsectionWithPath("aTDMTelphoneNumber").description("TDM Telphone Number"),
                ...
                subsectionWithPath("aBillingAccountNumber.aKeys").description("Billing Account Number Keys"),
