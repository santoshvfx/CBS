...
public class AddFiberServiceTNPortTestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        AddFiberServiceTNPortRequestDto request = AddFiberServiceTNPortRequestDto.builder()
                ...
                .aNewServiceProviderId("New Service Provider Id")
        ...
        given(documentationSpec)
                ...
                .filter(document("addFiberServiceTNPort",
                ...
                .post(StringUtils.join(DEFAULT_SPRING_BOOT_BASE_URI,
                        BisApi.RM_BASE_URL,
                        "/",
                        RmController.ADD_FIBER_SERVICE_TN_PORT_PATH_NAME))
                .then()
                .statusCode(500)
                .extract()
                .response()
