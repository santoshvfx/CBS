...
public class RetrieveServiceProvidersForResourceTestE2ESat_Prod extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        String responseBody = given(documentationSpec)
                ...
                .filter(document("retrieveServiceProvidersForResource-sat_prod",
