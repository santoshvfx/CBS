...
public class ValidateFacility3TestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        ValidateFacility3RequestDto request = ValidateFacility3RequestDto.builder()
        ...
        given(documentationSpec)
                ...
                .filter(document("validateFacility3",
                ...
                .post(StringUtils.join(DEFAULT_SPRING_BOOT_BASE_URI,
                        BisApi.RM_BASE_URL,
                        "/",
                        RmController.VALIDATE_FACILITY_3_PATH_NAME))
                .then()
                .statusCode(500)
                .extract()
                .response()
