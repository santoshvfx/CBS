...
public class SendFacilityAssignmentOrder3TestE2E extends AbstractControllerE2E {
    ...
    public void shouldReturnValidResponse(User user, int httpStatus) throws Exception {
        ...
        SendFacilityAssignmentOrder3RequestDto request = SendFacilityAssignmentOrder3RequestDto.builder()
                ...
                .aDSLDisconnectTelephoneNumber(new StringOpt())
        ...
        given(documentationSpec)
                ...
                .filter(document("sendFacilityAssignmentOrder3",
    ...
    private FieldDescriptor[] getRequestFieldDescriptor() {
        return new FieldDescriptor[] {
                ...
                subsectionWithPath("aDryloopRelatedCircuitId").description("Dryloop Related CircuitId"),

                subsectionWithPath("aDSLDisconnectTelephoneNumber").description("DSL Disconnect Telephone Number"),
