// $Id: SendFacilityAssignmentOrderBean.java,v 1.5 2006/08/24 16:32:24 ds4987 Exp $
//###############################################################################
//#
//#   Copyright Notice:
//#
...
public class SendFacilityAssignmentOrderBean
	extends com.sbc.eia.bis.RmNam.utilities.TranBase
	implements SessionBean, SendFacilityAssignmentOrder {
	...
	private com
		...
		.SendFacilityAssignmentOrder cacheSendFacilityAssignmentOrder =
		null;
	...
	public SendFacilityAssignmentOrderReturn sendFacilityAssignmentOrder(
		...
		log(
			LOG_DEBUG_LEVEL_1,
			"RM SendFacilityAssignmentOrder - SendFacilityAssignmentOrder");
		SendFacilityAssignmentOrderReturn retVal = null;

		try {

			if (cacheSendFacilityAssignmentOrder == null)
				cacheSendFacilityAssignmentOrder =
					new com
						.sbc
						.eia
						.bis
						...
						.transactions
						.SendFacilityAssignmentOrder
						.SendFacilityAssignmentOrder(getPROPERTIES());
			retVal =
				cacheSendFacilityAssignmentOrder.execute(
					aContext,
