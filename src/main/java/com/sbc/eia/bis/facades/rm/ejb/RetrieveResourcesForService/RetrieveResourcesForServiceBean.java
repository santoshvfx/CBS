...
public class RetrieveResourcesForServiceBean
	extends com.sbc.eia.bis.RmNam.utilities.TranBase
	implements SessionBean, RetrieveResourcesForService {
	...
	private com
		...
		.RetrieveResourcesForService cacheRetrieveResourcesForService =
		null;
	...
	public RetrieveResourcesForServiceReturn retrieveResourcesForService(
		...
		log(
			LOG_DEBUG_LEVEL_1,
			"RM RetrieveResourcesForService - retrieveResourcesForService");
		RetrieveResourcesForServiceReturn retVal = null;

		try {

			if (cacheRetrieveResourcesForService == null)
				cacheRetrieveResourcesForService =
					new com
						.sbc
						.eia
						.bis
						...
						.transactions
						.RetrieveResourcesForService
						.RetrieveResourcesForService(getPROPERTIES());
			retVal =
				cacheRetrieveResourcesForService.execute(
					 callerContext,
					 aServiceHandle,
					 aResourceRoleNames,
					 aLogger);
			...
			log(LOG_DEBUG_LEVEL_1, "RM RetrieveResourcesForService - retrieveResourcesForService");
		}
		return retVal;
	}
}
