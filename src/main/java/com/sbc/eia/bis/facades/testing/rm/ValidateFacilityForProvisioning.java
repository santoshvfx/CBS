...
import com.sbc.eia.idl.rm.RmFacadePackage._validateFacilityForProvisioningResponse;
import com.sbc.eia.idl.rm.RmFacadePackage._validateFacilityForProvisioningResponseMsg;
...
/**
 * ValidateFacilityForProvisioning test driver.
 * 
 * @author: Lira Galsim
 */
public class ValidateFacilityForProvisioning 
	extends TestRMCaseBase 
	{		
	    private ValidateFacilityForProvisioningReturn aResult = null;
	    ...
	    public ValidateFacilityForProvisioning() 
	    {
	        ...
	        // set method name
	        setMyMethodName("ValidateFacilityForProvisioning");
	    }
	    ...
	    protected void displayResult() 
	    {
	        ...
	        if (isXMLTestData) 
	        {
	            _validateFacilityForProvisioningResponse res =  new _validateFacilityForProvisioningResponse();
	            String responseXML = null;
	            
	            if (aResult != null) 
	            {       
	                res.aValidateFacilityForProvisioningReturn(aResult);
	                responseXML = convertMMarshalObjectToXML(new _validateFacilityForProvisioningResponseMsg(res));
	            }
	            else  
	            {
	        ...
	        {
	            TestClient.log.printLog("OUTPUT DATA: " + (new ValidateFacilityForProvisioningReturnBisHelper(aResult)).toString());
	        }
	    }
	            ...
	            DataNotFound 
        {
	        ...
	        com.sbc.eia.bis.facades.rm.transactions.ValidateFacilityForProvisioning.ValidateFacilityForProvisioning aTrans =
	            new com.sbc.eia.bis.facades.rm.transactions.ValidateFacilityForProvisioning.ValidateFacilityForProvisioning(aProps);
	            ...
	            RemoteException 
	    {
	        ...
	        aResult = ((Rm) remote).validateFacilityForProvisioning((aContext != null) ? aContext : TestClient.myBisContext,                
									                  				 this.aServiceLocation,
									                  				 this.aRelatedCircuitID,
													                 this.aWorkingTelephoneNumber,
													                 this.aMaxPairsToAnalyze,
