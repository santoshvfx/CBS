...
public class RetrieveServiceProvidersForServiceBean
	extends com.sbc.eia.bis.RmNam.utilities.TranBase
	implements SessionBean, RetrieveServiceProvidersForService {
	...
	private com
		...
		.RetrieveServiceProvidersForService cacheRetrieveServiceProvidersForService =
		null;
	...
	public RetrieveServiceProvidersForServiceReturn retrieveServiceProvidersForService(
		...
		log(
			LOG_DEBUG_LEVEL_1,
			"RM RetrieveServiceProvidersForService - retrieveServiceProvidersForService");
		RetrieveServiceProvidersForServiceReturn retVal = null;

		try {

			if (cacheRetrieveServiceProvidersForService == null)
				cacheRetrieveServiceProvidersForService =
					new com
						.sbc
						.eia
						.bis
						...
						.transactions
						.RetrieveServiceProvidersForService
						.RetrieveServiceProvidersForService(getPROPERTIES());
			retVal =
				cacheRetrieveServiceProvidersForService.execute(
					 callerContext,
					 aServiceHandle,
					 aServiceTypeHandles,
					 aLogger);
			...
			log(LOG_DEBUG_LEVEL_1, "RM RetrieveServiceProvidersForService - retrieveServiceProvidersForService");
		}
		return retVal;
	}
}
