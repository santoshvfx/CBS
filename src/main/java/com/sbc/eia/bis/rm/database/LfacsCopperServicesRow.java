//$Id: LfacsCopperServicesRow.java,v 1.1 2009/02/05 03:01:24 lg4542 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
/**
 * Class      : LfacsCopperServicesRow
 * Description: Class file for retrieving rows 
 * from LFACS_COPPER_SERVICES_VIEW.
 */
public class LfacsCopperServicesRow extends DBRowBase
{
    private java.lang.String REGION = "";
	private java.lang.String LS_CONDITIONED = "";
     ...
     */
    public LfacsCopperServicesRow(String aREGION, String aLS_CONDITIONED, String aCLS_SERVICE_CODE, 
    		String aCLS_MODIFIER, String aUSOC, String aSERVICE_CATEGORY, String aSERVICE_NAME, 
    		String aPROVISIONING_CONFLICT_IND, String aNEGOTIATION_CONFLICT_IND, int aPRIORITY_NUMBER)
    {
        super();
    ...
    public void setRow(ResultSet rs, Logger aLogger) throws SQLException
    {
        if (rs.next())
        {
            ...
            this.setLS_CONDITIONED(rs.getString(2));
            ...
            this.setPRIORITY_NUMBER(rs.getInt(10));
        }
    }
     ...
     */
    public java.lang.String getLS_CONDITIONED()
    {
     ...
     */
    public void setLS_CONDITIONED(java.lang.String ls_conditioned)
    {
