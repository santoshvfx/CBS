//$Id: EastSoacServiceOrderGenerator.java,v 1.9 2009/03/10 20:37:32 dl8121 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
public class EastSoacServiceOrderGenerator extends SoacFcifGenerator
{
     ...
     */
    public EastSoacServiceOrderGenerator()
    {
        super();
    ...
    public void generate(ParseRequestI request) throws GeneratorException
    {
        ...
        //    setEntity((String) soacServiceOrderVo.get("ENTITY"));
    ...
    protected StringBuffer generateControlSection()
    {
        ...
        if(soacServiceOrderVo.get(SoacServiceOrderConstants.CORRECTION_SUFFIX) != null
                && !soacServiceOrderVo.get(
                        SoacServiceOrderConstants.CORRECTION_SUFFIX).equals(""))
        {
            sbControlSection.append(soacServiceOrderVo.get(
        ...
        sbControlSection.append(SpaceSeparator.S6);
    ...
    protected StringBuffer generateSvcOrderText()
    {
        ...
        sbServiceOrderText.append(SpaceSeparator.S20);
        sbServiceOrderText
        ...
        sbServiceOrderText
                .append(formatDate
                        .DateFormat2((String) soacServiceOrderVo.get(
                                SoacServiceOrderConstants.ORIGINAL_DUE_DATE)
                                .toString()));
        ...
        if(soacServiceOrderVo.get(SoacServiceOrderConstants.SUBSEQ_DUE_DATE) != null)
        {
                    ...
                    SoacServiceOrderConstants.SUBSEQ_DUE_DATE).equals(""))
            {
                ...
                sbServiceOrderText
                        .append(formatDate
                                .DateFormat2((String) soacServiceOrderVo
    ...
    protected StringBuffer generateListingSection()
    {
        ...
        //There is no listing section tag in SBC East.
    ...
    {
        String methodName = "EastSoacServiceOrderGenerator: generateSandESection()";
