//$Id: PublishValidateFacilityNotificationResponseFTTP.java,v 1.8 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
//# 04/28/2008   Jon Costa			   PR21969394: Add back default of RTID Source to "OVALS".
...
/**
 * Class      : PublishValidateFacilityNotificationResponseFTTP
 * Description: Helper used for formatting the pVFN response message for FTTP network type.  
 */
public class PublishValidateFacilityNotificationResponseFTTP
    ...
    implements PublishValidateFacilityNotificationResponseIF
{
    ...
    /**
     * Constructor: PublishValidateFacilityNotificationResponseFTTP
     * @author Rene Duka
     */
    public PublishValidateFacilityNotificationResponseFTTP() 
    {
        // set default values
