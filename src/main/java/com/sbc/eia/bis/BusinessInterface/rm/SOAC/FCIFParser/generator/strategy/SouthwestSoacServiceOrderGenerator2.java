//$Id: SouthwestSoacServiceOrderGenerator2.java,v 1.4 2008/06/09 16:43:24 op1664 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
 ...
 */
public class SouthwestSoacServiceOrderGenerator2 extends
        SouthwestSoacServiceOrderGenerator
{
    /* 
     * Overrides appendBillingAccountNumber() so that it will use
     * appendBillingAccountNumber2() to satisfy LS7 requirement
     */
	protected void appendBillingAccountNumber(SoacServiceOrderVO aSoacServcieVo, StringBuffer aRemarkSection)
	{
	 ...
	 */
	protected void appendSandESection(SoacServiceOrderVO aSoacServcieVo, StringBuffer aSandESection)
	{
     ...
     */
	protected void appendBCCR(SoacServiceOrderVO aSoacServiceOrderVo,StringBuffer aSandESection)
	{
     ...
     */
    protected void appendNewConnectDisconnectForFTTNBP(SoacServiceOrderVO aSoacServiceOrderVo,
