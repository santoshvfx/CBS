//$Id: PublishValidateFacilityNotificationResponseFTTNBP.java,v 1.6 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
//# Date       | Author              | Notes
//# --------------------------------------------------------------------
//# 02/07/2008   Rene Duka             LS7. Creation.
...
/**
 * Class      : PublishValidateFacilityNotificationResponseFTTNBP
 * Description: Helper used for formatting the pVFN response message for FTTN-BP network type.  
 */
public class PublishValidateFacilityNotificationResponseFTTNBP
    ...
    implements PublishValidateFacilityNotificationResponseIF
{
     ...
     * @author Rene Duka
     */
    public PublishValidateFacilityNotificationResponseFTTNBP() 
    {
        // set default values
