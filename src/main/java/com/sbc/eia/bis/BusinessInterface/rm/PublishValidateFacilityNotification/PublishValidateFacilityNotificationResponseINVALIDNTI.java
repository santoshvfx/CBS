//$Id: PublishValidateFacilityNotificationResponseINVALIDNTI.java,v 1.5 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
/**
 * Class : PublishValidateFacilityNotificationResponseINVALIDNTI Description:
 * Helper used for formatting the pVFN response message for invalid network
 * type.
 */
public class PublishValidateFacilityNotificationResponseINVALIDNTI 
		...
		implements PublishValidateFacilityNotificationResponseIF
{
    public static String myClassName = 
        "com.sbc.eia.bis.BusinessInterface.rm.PublishValidateFacilityNotification.PublishValidateFacilityNotificationResponseINVALIDNTI";
     ...
     * @author Jon Costa
     */
    public PublishValidateFacilityNotificationResponseINVALIDNTI()
    {
        // set default values
     ...
     * @author Jon Costa
     */
    public PublishValidateFacilityNotificationResponseINVALIDNTI(Utility utility, Hashtable properties)
    {
        this();
