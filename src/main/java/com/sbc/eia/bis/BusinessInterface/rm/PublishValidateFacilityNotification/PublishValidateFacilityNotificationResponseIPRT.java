//$Id: PublishValidateFacilityNotificationResponseIPRT.java,v 1.3 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
//# Date       | Author              | Notes
//# --------------------------------------------------------------------
//# 01/14/2008   Julius Sembrano       LS 10. Creation.
...
/**
 * Class      : PublishValidateFacilityNotificationResponseIPRT
 * Description: Helper used for formatting the pVFN response message for IPRT network type.  
 */
public class PublishValidateFacilityNotificationResponseIPRT
    ...
    implements PublishValidateFacilityNotificationResponseIF
{
    ...
    /**
     * Constructor: PublishValidateFacilityNotificationResponseIPRT
     * @author Julius Sembrano
     */
    public PublishValidateFacilityNotificationResponseIPRT() 
    {
        // set default values
