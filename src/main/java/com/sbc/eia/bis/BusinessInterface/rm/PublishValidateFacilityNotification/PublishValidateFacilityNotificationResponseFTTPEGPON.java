//$Id: PublishValidateFacilityNotificationResponseFTTPEGPON.java,v 1.5 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
/**
 * Class : PublishValidateFacilityNotificationResponseFTTPEGPON Description:
 * Helper used for formatting the pVFN response message for FTTP_EGPON network
 * type.
 */
public class PublishValidateFacilityNotificationResponseFTTPEGPON 
		...
		implements PublishValidateFacilityNotificationResponseIF
{
     ...
     * @author Jon Costa
     */
    public PublishValidateFacilityNotificationResponseFTTPEGPON()
    {
        // set default values
     ...
     * @author Jon Costa
     */
    public PublishValidateFacilityNotificationResponseFTTPEGPON(Utility utility, Hashtable properties)
    {
        this();
