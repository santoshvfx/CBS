//$Id: PublishValidateFacilityNotificationResponseGPON.java,v 1.6 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
/**
 * Class      : PublishValidateFacilityNotificationResponseGPON
 * Description: Helper used for formatting the pVFN response message for GPON network type.  
 */
public class PublishValidateFacilityNotificationResponseGPON
    ...
    implements PublishValidateFacilityNotificationResponseIF
{
    ...
    /**
     * Constructor: PublishValidateFacilityNotificationResponseGPON
     * @author Rene Duka
     */
    public PublishValidateFacilityNotificationResponseGPON() 
    {
        // set default values
