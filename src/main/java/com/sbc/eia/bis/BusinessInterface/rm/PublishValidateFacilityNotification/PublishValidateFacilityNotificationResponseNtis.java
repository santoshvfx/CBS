//$Id: PublishValidateFacilityNotificationResponseNtis.java,v 1.4 2009/07/25 02:23:34 js7440 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
//# Date       | Author              | Notes
//# --------------------------------------------------------------------
//# 02/07/2008   Rene Duka             LS 7. Creation.
...
/**
 * Class      : PublishValidateFacilityNotificationResponseRGPON
 * Description: Helper used for formatting the pVFN response message for RGPON network type.  
 */
public class PublishValidateFacilityNotificationResponseNtis
    ...
    implements PublishValidateFacilityNotificationResponseIF
{
    ...
    /**
     * Constructor: PublishValidateFacilityNotificationResponseRGPON
     * @author Rene Duka
     */
    public PublishValidateFacilityNotificationResponseNtis() 
    {
        // set default values
    ...
    public String getANetworkType()
    {
        return aNetworkType;
    }

    public void setANetworkType(String networkType)
    {
        aNetworkType = networkType;
    }

    public String getAWTN()
    {
        return aWTN;
    }

    public void setAWTN(String awtn)
    {
        aWTN = awtn;
    }
