 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SouthwestSoacFcifServiceOrderParserTest extends TestCase
{
	 ...
	 */
	public SouthwestSoacFcifServiceOrderParserTest(String arg0)
	{
		super(arg0);
	}
...
//		request.setSon("C060211");
	...
	{	
		...
		for(int i = 0; i < files.length; i ++)
		{
            ...
            String obpData = accessor.getOutBindingPostData();
	...
	private String generateFcifString(File file)
	{
		...
		try
		{
            ...
            System.out.println(request.getAssignmentString());            
		}
