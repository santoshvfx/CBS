...
public class AttributeErrorItemSeqTypeImpl implements com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.AttributeErrorItemSeqType, com.sun.xml.bind.JAXBObject, com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.UnmarshallableObject, com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.XMLSerializable, com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.AttributeErrorItemSeqType.class);
    }

    public java.util.List getAttributeError() {
    ...
    public com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.UnmarshallingContext context) {
        return new com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.AttributeErrorItemSeqTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _AttributeError.size();
        while (idx1 != len1) {
            context.startElement("", "attributeError");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _AttributeError.get(idx_0 ++)), "AttributeError");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _AttributeError.get(idx_1 ++)), "AttributeError");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _AttributeError.get(idx1 ++)), "AttributeError");
            context.endElement();
        }
    }
...
+";L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0003\u00e4\u0011\u008eppsr\u0000\'com.sun.msv.grammar.trex.Ele"
+"mentPattern\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\tnameClasst\u0000\u001fLcom/sun/msv/grammar/Na"
+"meClass;xr\u0000\u001ecom.sun.msv.grammar.ElementExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002Z\u0000\u001aigno"
+"reUndeclaredAttributesL\u0000\fcontentModelq\u0000~\u0000\u0002xq\u0000~\u0000\u0003\u0003\u00e4\u0011\u008bpp\u0000sr\u0000\u001fc"
+"om.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001dcom.sun.msv.gra"
+"mmar.BinaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0004exp1q\u0000~\u0000\u0002L\u0000\u0004exp2q\u0000~\u0000\u0002xq\u0000~\u0000\u0003\u0003\u00e4\u0011\u0080p"
...
+".AttributeErrorItemTypet\u0000+http://java.sun.com/jaxb/xjc/dummy"
+"-elementssq\u0000~\u0000\u000e\u0003|\u00bc\u0083ppsq\u0000~\u0000\u0013\u0003|\u00bcxq\u0000~\u0000\u0012psr\u0000\u001bcom.sun.msv.grammar"
...
+"\u001dt\u0000\u000eattributeErrort\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000"
...
+"grammar.Expression;\u00d68D\u00c3]\u00ad\u00a7\n\u0002\u0000\u0000xp\u0000\u0000\u0000\u00bfpppppppppppppppq\u0000~\u0000\"pppp"
+"pppppppppppppq\u0000~\u0000\u0010ppppppppppq\u0000~\u0000\u000fppppppppppppppppppppppppppp"
+"pppq\u0000~\u0000\fpppppppppppppq\u0000~\u0000\u0005pppppppppppppppppppppppppppppppppp"
...
+"ppppppp"));
        ...
        extends com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.AttributeErrorItemSeqTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("name" == ___local)&&("" == ___uri)) {
                            _AttributeError.add(((com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.AttributeErrorItemTypeImpl) spawnChildFromEnterElement((com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.AttributeErrorItemTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
