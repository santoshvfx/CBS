...
/*
 * @(#)$Id: SAXUnmarshallerHandlerImpl.java,v 1.13 2003/08/13 00:18:07 kk122374 Exp $
 */
    ...
    implements SAXUnmarshallerHandler, UnmarshallingContext
{
    ...
    /** stack of collectText flag. False means text can be ignored. */ 
    ...
    private final boolean shouldCollectText() {
        return collectText[collectTextTop];
    }
...
//
    ...
    public String[] getNewlyDeclaredPrefixes() {
        return getPrefixList( idxStack[idxStackTop-1] );
    }
    ...
    private String[] getPrefixList( int startIndex ) {
        int size = (idxStack[idxStackTop]-startIndex)/2;
...
//
    ...
    public void pushAttributes( Attributes atts, boolean collectTextFlag ) {
        ...
        if( ++collectTextTop==collectText.length ) {
            // reallocation
            boolean[] newBuf = new boolean[collectText.length*2];
            System.arraycopy(collectText,0,newBuf,0,collectText.length);
            collectText = newBuf;
        }
        collectText[collectTextTop] = collectTextFlag;
    }
