...
public class LogMessageSeqTypeImpl implements com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.LogMessageSeqType, com.sun.xml.bind.JAXBObject, com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.UnmarshallableObject, com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.XMLSerializable, com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _LogMessage = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.LogMessageSeqType.class);
    }

    public java.util.List getLogMessage() {
        return _LogMessage;
    }
    ...
    public com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.UnmarshallingContext context) {
        return new com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.LogMessageSeqTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _LogMessage.size();
        while (idx1 != len1) {
            context.startElement("", "logMessage");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _LogMessage.get(idx_0 ++)), "LogMessage");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _LogMessage.get(idx_1 ++)), "LogMessage");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _LogMessage.get(idx1 ++)), "LogMessage");
            context.endElement();
        }
    }
...
+";L\u0000\u000bexpandedExpq\u0000~\u0000\u0002xp\u0002\u0081\u00cb\u00d2ppsr\u0000\'com.sun.msv.grammar.trex.Ele"
+"mentPattern\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\tnameClasst\u0000\u001fLcom/sun/msv/grammar/Na"
+"meClass;xr\u0000\u001ecom.sun.msv.grammar.ElementExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002Z\u0000\u001aigno"
+"reUndeclaredAttributesL\u0000\fcontentModelq\u0000~\u0000\u0002xq\u0000~\u0000\u0003\u0002\u0081\u00cb\u00cfpp\u0000sr\u0000\u001fc"
+"om.sun.msv.grammar.SequenceExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001dcom.sun.msv.gra"
+"mmar.BinaryExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0002L\u0000\u0004exp1q\u0000~\u0000\u0002L\u0000\u0004exp2q\u0000~\u0000\u0002xq\u0000~\u0000\u0003\u0002\u0081\u00cb\u00c4p"
...
+".LogMessageTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-element"
+"ssq\u0000~\u0000\u000e\u0002\u001av\u00c7ppsq\u0000~\u0000\u0013\u0002\u001av\u00bcq\u0000~\u0000\u0012psr\u0000\u001bcom.sun.msv.grammar.DataExp"
...
+"essaget\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000"
...
+"\u0000\u0010ppppppppppq\u0000~\u0000\u000fppppppppppppq\u0000~\u0000\fpppppppppppppq\u0000~\u0000\u0005pppppppp"
+"pppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp"
+"ppppppppppppppppppppppppppppppppppppppppppppppppq\u0000~\u0000\"pp"));
        }
        ...
        extends com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.LogMessageSeqTypeImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("source" == ___local)&&("" == ___uri)) {
                            _LogMessage.add(((com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.LogMessageTypeImpl) spawnChildFromEnterElement((com.sbc.eia.bis.embus.service.network.npconnector.rmbisrequests.interfaces.impl.LogMessageTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
