...
public class Header_tHelper { 
	...
	public static com.sbc.gwsvcs.service.toplistener.interfaces.Header_t read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.toplistener.interfaces.Header_t value = new com.sbc.gwsvcs.service.toplistener.interfaces.Header_t();
		{
		...
		value.TRNSPT_CD = com.sbc.gwsvcs.service.toplistener.interfaces.TrnsptType_eHelper.read (i);
		{
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.toplistener.interfaces.Header_t value) { 
		{
			byte[] _bytes = new byte[15];
		...
		com.sbc.gwsvcs.service.toplistener.interfaces.TrnsptType_eHelper.write (o, value.TRNSPT_CD);
		{
			byte[] _bytes = new byte[121];
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.toplistener.interfaces.Header_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.toplistener.interfaces.Header_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[0].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.toplistener.interfaces.UUID_tHelper.id(), "UUID_t", members[0].type);
				members[1] = new StructMember();
				members[1].name = "CLNT_CONTEXT";
				members[1].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[1].type = ORB.init().create_array_tc (31, members[1].type);
				members[1].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.toplistener.interfaces.Context_tHelper.id(), "Context_t", members[1].type);
				...
				members[2].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.toplistener.interfaces.HostNm_tHelper.id(), "HostNm_t", members[2].type);
				...
				members[3].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.toplistener.interfaces.TranID_tHelper.id(), "TranID_t", members[3].type);
				members[4] = new StructMember();
				members[4].name = "TRNSPT_CD";
				members[4].type = com.sbc.gwsvcs.service.toplistener.interfaces.TrnsptType_eHelper.type();
				...
				members[5].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.toplistener.interfaces.Destination_tHelper.id(), "Destination_t", members[5].type);
	...
	public static String id() { return "IDL:com/sbc/gwsvcs/service/toplistener/interfaces/Header_t:1.0"; } 
}
