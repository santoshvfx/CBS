// $Id: RdlocGrpDefHelper.java,v 1.1 2002/09/29 04:10:29 dm2328 Exp $
...
public class RdlocGrpDefHelper { 
	private static TypeCode myTc = null;
	private RdlocGrpDefHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocGrpDef extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/RdlocGrpDef:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocGrpDef t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocGrpDef read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocGrpDef value = new com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocGrpDef();
		{
			...
			for (_j = 0; _j < 12; _j++)
				if (_bytes[_j] == 0)
					break;
			value.locationcode = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 9; _j++)
				if (_bytes[_j] == 0)
					break;
			value.effdate = new String (_bytes, 0, _j);
		}
		return value; 
	}
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[4].name = "effdate";
			members[4].type = ORB.init().create_array_tc (
				9, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "RdlocGrpDef", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocGrpDef value) { 
		{
			byte[] _bytes = new byte[12];
			byte[] _bytes_src = value.locationcode.getBytes();
			int _j;
			for (_j = 0; _j < 12 - 1; _j++)
		...
		{
			byte[] _bytes = new byte[9];
			byte[] _bytes_src = value.effdate.getBytes();
			int _j;
			for (_j = 0; _j < 9 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
