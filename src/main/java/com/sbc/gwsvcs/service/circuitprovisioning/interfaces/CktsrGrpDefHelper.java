// $Id: CktsrGrpDefHelper.java,v 1.1 2002/09/29 04:10:28 dm2328 Exp $
...
public class CktsrGrpDefHelper { 
	private static TypeCode myTc = null;
	private CktsrGrpDefHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CktsrGrpDef extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/CktsrGrpDef:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CktsrGrpDef t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CktsrGrpDef read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 9; _j++)
				if (_bytes[_j] == 0)
					break;
			value.pdac = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 4; _j++)
				if (_bytes[_j] == 0)
					break;
			value.piu = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.eac = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[14].type = ORB.init().create_array_tc (
				2, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "CktsrGrpDef", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CktsrGrpDef value) { 
		{
			byte[] _bytes = new byte[2];
		...
		{
			byte[] _bytes = new byte[9];
			byte[] _bytes_src = value.pdac.getBytes();
			int _j;
			for (_j = 0; _j < 9 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[4];
			byte[] _bytes_src = value.piu.getBytes();
			int _j;
			for (_j = 0; _j < 4 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.eac.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
