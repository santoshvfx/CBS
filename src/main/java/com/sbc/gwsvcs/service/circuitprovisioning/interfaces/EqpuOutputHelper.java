// $Id: EqpuOutputHelper.java,v 1.1 2002/09/29 04:10:28 dm2328 Exp $
...
public class EqpuOutputHelper { 
	private static TypeCode myTc = null;
	private EqpuOutputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuOutput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/EqpuOutput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuOutput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuOutput read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 9; _j++)
				if (_bytes[_j] == 0)
					break;
			value.hecig = new String (_bytes, 0, _j);
		}
		{ 
			value.EqpuGrp = new com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuGrpDef[80];
			for (int __i0 = 0; __i0 < 80; __i0++) { 
				value.EqpuGrp[__i0] = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuGrpDefHelper.read (i);
			} 
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[4].name = "hecig";
			members[4].type = ORB.init().create_array_tc (
				9, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[5] = new StructMember();
			members[5].name = "EqpuGrp";
			members[5].type = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuGrpDefHelper.type();
			members[5].type = ORB.init().create_array_tc (80, members[5].type);
			members[6] = new StructMember();
			members[6].name = "msgid";
			members[6].type = ORB.init().create_array_tc (
				81, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "EqpuOutput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuOutput value) { 
		...
		{
			byte[] _bytes = new byte[9];
			byte[] _bytes_src = value.hecig.getBytes();
			int _j;
			for (_j = 0; _j < 9 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{ 
			for (int __i0 = 0; __i0 < 80; __i0++) { 
				com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpuGrpDefHelper.write (o, value.EqpuGrp[__i0]);
			} 
		}
		{
			byte[] _bytes = new byte[81];
