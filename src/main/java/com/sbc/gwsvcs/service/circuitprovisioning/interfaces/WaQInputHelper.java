// $Id: WaQInputHelper.java,v 1.1 2002/09/29 04:10:30 dm2328 Exp $
...
public class WaQInputHelper { 
	private static TypeCode myTc = null;
	private WaQInputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQInput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/WaQInput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQInput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQInput read (org.omg.CORBA.portable.InputStream i) { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			myTc = ORB.init().create_struct_tc (id(), "WaQInput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQInput value) { 
		{
			byte[] _bytes = new byte[9];
