// $Id: TastgnOutputHelper.java,v 1.1 2002/09/29 04:10:29 dm2328 Exp $
...
public class TastgnOutputHelper { 
	private static TypeCode myTc = null;
	private TastgnOutputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnOutput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/TastgnOutput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnOutput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnOutput read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 12; _j++)
				if (_bytes[_j] == 0)
					break;
			value.a = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[12];
			i.read_octet_array (_bytes, 0, 12);
			...
			for (_j = 0; _j < 12; _j++)
				if (_bytes[_j] == 0)
					break;
			value.z = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 3; _j++)
				if (_bytes[_j] == 0)
					break;
			value.action = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 7; _j++)
				if (_bytes[_j] == 0)
					break;
			value.duedate = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 9; _j++)
				if (_bytes[_j] == 0)
					break;
			value.view = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[9];
			i.read_octet_array (_bytes, 0, 9);
		...
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.trk = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[7];
			i.read_octet_array (_bytes, 0, 7);
			...
			for (_j = 0; _j < 7; _j++)
				if (_bytes[_j] == 0)
					break;
			value.lastupdt = new String (_bytes, 0, _j);
		}
		{ 
			value.TastgnGrp = new com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnGrpDef[18];
			for (int __i0 = 0; __i0 < 18; __i0++) { 
				value.TastgnGrp[__i0] = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnGrpDefHelper.read (i);
			} 
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[2].type = ORB.init().create_array_tc (
				24, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			...
			members[16].name = "lastupdt";
			members[16].type = ORB.init().create_array_tc (
				7, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[17] = new StructMember();
			members[17].name = "TastgnGrp";
			members[17].type = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnGrpDefHelper.type();
			members[17].type = ORB.init().create_array_tc (18, members[17].type);
			...
			myTc = ORB.init().create_struct_tc (id(), "TastgnOutput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnOutput value) { 
		...
		{
			byte[] _bytes = new byte[12];
			byte[] _bytes_src = value.a.getBytes();
			int _j;
			for (_j = 0; _j < 12 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[12];
			byte[] _bytes_src = value.z.getBytes();
			int _j;
			for (_j = 0; _j < 12 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[3];
			byte[] _bytes_src = value.action.getBytes();
			int _j;
			for (_j = 0; _j < 3 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[7];
			byte[] _bytes_src = value.duedate.getBytes();
			int _j;
			for (_j = 0; _j < 7 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[9];
			byte[] _bytes_src = value.view.getBytes();
			int _j;
			for (_j = 0; _j < 9 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.trk.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[7];
			byte[] _bytes_src = value.lastupdt.getBytes();
			int _j;
			for (_j = 0; _j < 7 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{ 
			for (int __i0 = 0; __i0 < 18; __i0++) { 
				com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnGrpDefHelper.write (o, value.TastgnGrp[__i0]);
			} 
		}
		{
			byte[] _bytes = new byte[81];
