// $Id: TgmrOutputHelper.java,v 1.1 2002/09/29 04:10:29 dm2328 Exp $
...
public class TgmrOutputHelper { 
	private static TypeCode myTc = null;
	private TgmrOutputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgmrOutput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/TgmrOutput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgmrOutput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgmrOutput read (org.omg.CORBA.portable.InputStream i) { 
		...
		{ 
			...
			for (int __i0 = 0; __i0 < 5; __i0++) { 
				value.TgmrGrp[__i0] = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgmrGrpDefHelper.read (i);
			} 
		}
		{
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.ineffect = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[6];
			i.read_octet_array (_bytes, 0, 6);
		...
		}
		{
			...
			for (_j = 0; _j < 12; _j++)
				if (_bytes[_j] == 0)
					break;
			value.custswloc = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[6];
			i.read_octet_array (_bytes, 0, 6);
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.pendingdisc = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[6];
			i.read_octet_array (_bytes, 0, 6);
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.pendingconn = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[6];
			i.read_octet_array (_bytes, 0, 6);
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.pendingdet = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[6];
			i.read_octet_array (_bytes, 0, 6);
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.pendingatt = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[12];
			i.read_octet_array (_bytes, 0, 12);
		...
		}
		{
			...
			for (_j = 0; _j < 7; _j++)
				if (_bytes[_j] == 0)
					break;
			value.totalworking = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 21; _j++)
				if (_bytes[_j] == 0)
					break;
			value.rmks = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[12];
			i.read_octet_array (_bytes, 0, 12);
		...
		}
		{
			...
			for (_j = 0; _j < 12; _j++)
				if (_bytes[_j] == 0)
					break;
			value.custloc = new String (_bytes, 0, _j);
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[19].name = "custloc";
			members[19].type = ORB.init().create_array_tc (
				12, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[20] = new StructMember();
			members[20].name = "msgid";
			members[20].type = ORB.init().create_array_tc (
				81, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "TgmrOutput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgmrOutput value) { 
		...
		{ 
			for (int __i0 = 0; __i0 < 5; __i0++) { 
				com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgmrGrpDefHelper.write (o, value.TgmrGrp[__i0]);
			} 
		}
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.ineffect.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[12];
			byte[] _bytes_src = value.custswloc.getBytes();
			int _j;
			for (_j = 0; _j < 12 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.pendingdisc.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.pendingconn.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.pendingdet.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.pendingatt.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[7];
			byte[] _bytes_src = value.totalworking.getBytes();
			int _j;
			for (_j = 0; _j < 7 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[21];
			byte[] _bytes_src = value.rmks.getBytes();
			int _j;
			for (_j = 0; _j < 21 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[12];
			byte[] _bytes_src = value.custloc.getBytes();
			int _j;
			for (_j = 0; _j < 12 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
