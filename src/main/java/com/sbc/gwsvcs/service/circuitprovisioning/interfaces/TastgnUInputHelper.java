// $Id: TastgnUInputHelper.java,v 1.1 2002/09/29 04:10:29 dm2328 Exp $
...
public class TastgnUInputHelper { 
	private static TypeCode myTc = null;
	private TastgnUInputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnUInput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/TastgnUInput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnUInput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnUInput read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.prev_endtrunk = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.tgn = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.starttmn = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.starttrunkno = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.endtrunk = new String (_bytes, 0, _j);
		}
		return value; 
	}
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[7].name = "starttmn";
			members[7].type = ORB.init().create_array_tc (
				5, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[8] = new StructMember();
			members[8].name = "starttrunkno";
			members[8].type = ORB.init().create_array_tc (
				5, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[9] = new StructMember();
			members[9].name = "endtrunk";
			members[9].type = ORB.init().create_array_tc (
				5, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "TastgnUInput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TastgnUInput value) { 
		{
			byte[] _bytes = new byte[9];
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.prev_endtrunk.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.tgn.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.starttmn.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.starttrunkno.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.endtrunk.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
