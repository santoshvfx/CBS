// $Id: WaQTIRKSJXInputHelper.java,v 1.1 2011/04/04 13:43:24 jo8461 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
/**
 * Class      : WaQTIRKSJXInputHelper
 * Description: Helper used for handling the input of the TIRKSJX WA screen.
 * 
 * @author js7440
 */
public class WaQTIRKSJXInputHelper 
{ 
	private static TypeCode myTc = null;
	
    /**
     * Constructor: WaQTIRKSJXInputHelper
     * 
     * @author js7440
     */
	private WaQTIRKSJXInputHelper () 
	{
	}
	 ...
	 * @author js7440
	 */
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQTIRKSJXInput extract (
		org.omg.CORBA.Any a) 
		throws 
			BAD_OPERATION 
	{ 
	...
	{ 
		return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/WaQTIRKSJXInput:1.0"; 
	}
     ...
     * 
     * @param org.omg.CORBA.Any a
     * @param com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQTIRKSJXInput t
     * @author js7440
     */
	public static void insert (
		org.omg.CORBA.Any a, 
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQTIRKSJXInput t) 
	{ 
     ...
     * @author js7440
     */
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQTIRKSJXInput read (
	...
	{ 
		...
		{ 
			...
			myTc = ORB.init().create_struct_tc (id(), "WaQTIRKSJXInput", members); 
		}
		return myTc; 
	}
	 ...
	 * @param com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQTIRKSJXInput value
	 * @author js7440
	 */
	public static void write (
		org.omg.CORBA.portable.OutputStream o, 
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.WaQTIRKSJXInput value) 
	{ 
		{
			byte[] _bytes = new byte[9];
