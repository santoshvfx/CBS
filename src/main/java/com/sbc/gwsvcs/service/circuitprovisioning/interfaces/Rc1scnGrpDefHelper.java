// $Id: Rc1scnGrpDefHelper.java,v 1.1 2002/09/29 04:10:29 dm2328 Exp $
...
public class Rc1scnGrpDefHelper { 
	private static TypeCode myTc = null;
	private Rc1scnGrpDefHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1scnGrpDef extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/Rc1scnGrpDef:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1scnGrpDef t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1scnGrpDef read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1scnGrpDef value = new com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1scnGrpDef();
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.select = new String (_bytes, 0, _j);
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[6].type = ORB.init().create_array_tc (
				9, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "Rc1scnGrpDef", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1scnGrpDef value) { 
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.select.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
