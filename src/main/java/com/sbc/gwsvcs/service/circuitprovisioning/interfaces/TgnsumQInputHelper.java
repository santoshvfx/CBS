// $Id: TgnsumQInputHelper.java,v 1.1 2002/09/29 04:10:30 dm2328 Exp $
...
public class TgnsumQInputHelper { 
	private static TypeCode myTc = null;
	private TgnsumQInputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumQInput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/TgnsumQInput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumQInput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumQInput read (org.omg.CORBA.portable.InputStream i) { 
		...
		value.start_page = i.read_long ();
		value.end_page = i.read_long ();
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[5].name = "display";
			members[5].type = ORB.init().create_array_tc (
				2, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[6] = new StructMember();
			members[6].name = "starttgn";
			members[6].type = ORB.init().create_array_tc (
				5, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "TgnsumQInput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumQInput value) { 
		{
			byte[] _bytes = new byte[9];
		...
		o.write_long(value.start_page);
		o.write_long(value.end_page);
		{
			byte[] _bytes = new byte[12];
