// $Id: TgnsumGrpDefHelper.java,v 1.1 2002/09/29 04:10:30 dm2328 Exp $
...
public class TgnsumGrpDefHelper { 
	private static TypeCode myTc = null;
	private TgnsumGrpDefHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumGrpDef extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/TgnsumGrpDef:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumGrpDef t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumGrpDef read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.r = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 14; _j++)
				if (_bytes[_j] == 0)
					break;
			value.desc = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 17; _j++)
				if (_bytes[_j] == 0)
					break;
			value.cllitrkname = new String (_bytes, 0, _j);
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[8].name = "remarks";
			members[8].type = ORB.init().create_array_tc (
				15, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "TgnsumGrpDef", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.TgnsumGrpDef value) { 
		{
			byte[] _bytes = new byte[2];
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.r.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[14];
			byte[] _bytes_src = value.desc.getBytes();
			int _j;
			for (_j = 0; _j < 14 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[17];
			byte[] _bytes_src = value.cllitrkname.getBytes();
			int _j;
			for (_j = 0; _j < 17 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
