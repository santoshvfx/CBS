// $Id: CxrsOutputHelper.java,v 1.1 2002/09/29 04:10:28 dm2328 Exp $
...
public class CxrsOutputHelper { 
	private static TypeCode myTc = null;
	private CxrsOutputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsOutput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/CxrsOutput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsOutput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsOutput read (org.omg.CORBA.portable.InputStream i) { 
		...
		value.due_date_query = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Dt_tHelper.read (i);
		{
			byte[] _bytes = new byte[7];
			i.read_octet_array (_bytes, 0, 7);
			int _j;
			for (_j = 0; _j < 7; _j++)
				if (_bytes[_j] == 0)
					break;
			value.cxr_type = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[7];
			i.read_octet_array (_bytes, 0, 7);
			...
			for (_j = 0; _j < 7; _j++)
				if (_bytes[_j] == 0)
					break;
			value.subpath = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 8; _j++)
				if (_bytes[_j] == 0)
					break;
			value.fac_grp = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.dds = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.f_a = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 4; _j++)
				if (_bytes[_j] == 0)
					break;
			value.trans_rate = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.avail = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.currscan = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.timing_pri_sec = new String (_bytes, 0, _j);
		}
		{ 
			value.CxrsGrp = new com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsGrpDef[14];
			for (int __i0 = 0; __i0 < 14; __i0++) { 
				value.CxrsGrp[__i0] = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsGrpDefHelper.read (i);
			} 
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[7].name = "due_date_query";
			members[7].type = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Dt_tHelper.type();
			members[8] = new StructMember();
			members[8].name = "cxr_type";
			members[8].type = ORB.init().create_array_tc (
				7, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[9] = new StructMember();
			members[9].name = "subpath";
			members[9].type = ORB.init().create_array_tc (
				7, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[10] = new StructMember();
			members[10].name = "fac_grp";
			...
			members[14].name = "avail";
			members[14].type = ORB.init().create_array_tc (
				2, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[15] = new StructMember();
			members[15].name = "currscan";
			members[15].type = ORB.init().create_array_tc (
				2, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[16] = new StructMember();
			members[16].name = "timing_pri_sec";
			members[16].type = ORB.init().create_array_tc (
				2, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[17] = new StructMember();
			members[17].name = "CxrsGrp";
			members[17].type = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsGrpDefHelper.type();
			members[17].type = ORB.init().create_array_tc (14, members[17].type);
			members[18] = new StructMember();
			members[18].name = "msgid";
			members[18].type = ORB.init().create_array_tc (
				81, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "CxrsOutput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsOutput value) { 
		...
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Dt_tHelper.write (o, value.due_date_query);
		{
			byte[] _bytes = new byte[7];
			byte[] _bytes_src = value.cxr_type.getBytes();
			int _j;
			for (_j = 0; _j < 7 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[7];
			byte[] _bytes_src = value.subpath.getBytes();
			int _j;
			for (_j = 0; _j < 7 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[8];
			byte[] _bytes_src = value.fac_grp.getBytes();
			int _j;
			for (_j = 0; _j < 8 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.dds.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.f_a.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[4];
			byte[] _bytes_src = value.trans_rate.getBytes();
			int _j;
			for (_j = 0; _j < 4 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.avail.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.currscan.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.timing_pri_sec.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{ 
			for (int __i0 = 0; __i0 < 14; __i0++) { 
				com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CxrsGrpDefHelper.write (o, value.CxrsGrp[__i0]);
			} 
		}
		{
			byte[] _bytes = new byte[81];
