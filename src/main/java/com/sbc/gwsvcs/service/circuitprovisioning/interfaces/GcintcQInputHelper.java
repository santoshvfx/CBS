// $Id: GcintcQInputHelper.java,v 1.1 2002/09/29 04:10:28 dm2328 Exp $
...
public class GcintcQInputHelper { 
	private static TypeCode myTc = null;
	private GcintcQInputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.GcintcQInput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/GcintcQInput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.GcintcQInput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.GcintcQInput read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.t_input = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.entry_input = new String (_bytes, 0, _j);
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[5].name = "t_input";
			members[5].type = ORB.init().create_array_tc (
				2, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[6] = new StructMember();
			members[6].name = "entry_input";
			...
			myTc = ORB.init().create_struct_tc (id(), "GcintcQInput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.GcintcQInput value) { 
		{
			byte[] _bytes = new byte[9];
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.t_input.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.entry_input.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
