// $Id: Rc1cicAInputHelper.java,v 1.1 2002/09/29 04:10:29 dm2328 Exp $
...
public class Rc1cicAInputHelper { 
	private static TypeCode myTc = null;
	private Rc1cicAInputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1cicAInput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/Rc1cicAInput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1cicAInput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1cicAInput read (org.omg.CORBA.portable.InputStream i) { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[7].type = ORB.init().create_array_tc (
				6, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "Rc1cicAInput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Rc1cicAInput value) { 
		{
			byte[] _bytes = new byte[9];
