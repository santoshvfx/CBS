// $Id: EqpaQInputHelper.java,v 1.1 2002/09/29 04:10:28 dm2328 Exp $
...
public class EqpaQInputHelper { 
	private static TypeCode myTc = null;
	private EqpaQInputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpaQInput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/EqpaQInput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpaQInput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpaQInput read (org.omg.CORBA.portable.InputStream i) { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			myTc = ORB.init().create_struct_tc (id(), "EqpaQInput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.EqpaQInput value) { 
		{
			byte[] _bytes = new byte[9];
