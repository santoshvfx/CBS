// $Id: CblsOutputHelper.java,v 1.1 2002/09/29 04:10:28 dm2328 Exp $
...
public class CblsOutputHelper { 
	private static TypeCode myTc = null;
	private CblsOutputHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsOutput extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/CblsOutput:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsOutput t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsOutput read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.qty_spare = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[6];
			i.read_octet_array (_bytes, 0, 6);
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.tot_qty = new String (_bytes, 0, _j);
		}
		value.cmpl_date = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Dt_tHelper.read (i);
		{
			...
			for (_j = 0; _j < 3; _j++)
				if (_bytes[_j] == 0)
					break;
			value.inv_stat = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.x_2w_spares = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.x_1w_spares = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 15; _j++)
				if (_bytes[_j] == 0)
					break;
			value.fac_detail = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[3];
			i.read_octet_array (_bytes, 0, 3);
			...
			for (_j = 0; _j < 3; _j++)
				if (_bytes[_j] == 0)
					break;
			value.fac_use = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 10; _j++)
				if (_bytes[_j] == 0)
					break;
			value.fac_group = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[10];
			i.read_octet_array (_bytes, 0, 10);
			...
			for (_j = 0; _j < 10; _j++)
				if (_bytes[_j] == 0)
					break;
			value.comp_id = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.no_of_sprs = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.no_of_wires = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.shld_dir = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.ckt_clo_scan = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.alt_pri = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.dr_class = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[3];
			i.read_octet_array (_bytes, 0, 3);
			...
			for (_j = 0; _j < 3; _j++)
				if (_bytes[_j] == 0)
					break;
			value.misuse = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.mw = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[3];
			i.read_octet_array (_bytes, 0, 3);
			...
			for (_j = 0; _j < 3; _j++)
				if (_bytes[_j] == 0)
					break;
			value.termn_frames = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 4; _j++)
				if (_bytes[_j] == 0)
					break;
			value.seq_nbr = new String (_bytes, 0, _j);
		}
		{ 
			value.CblsGrp = new com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsGrpDef[12];
			for (int __i0 = 0; __i0 < 12; __i0++) { 
				value.CblsGrp[__i0] = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsGrpDefHelper.read (i);
			} 
		}
		{
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			StructMember members[] = new StructMember[31];
			...
			members[29].name = "CblsGrp";
			members[29].type = com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsGrpDefHelper.type();
			members[29].type = ORB.init().create_array_tc (12, members[29].type);
			members[30] = new StructMember();
			members[30].name = "msgid";
			members[30].type = ORB.init().create_array_tc (
				81, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "CblsOutput", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsOutput value) { 
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.qty_spare.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.tot_qty.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.Dt_tHelper.write (o, value.cmpl_date);
		{
			byte[] _bytes = new byte[3];
			byte[] _bytes_src = value.inv_stat.getBytes();
			int _j;
			for (_j = 0; _j < 3 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.x_2w_spares.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.x_1w_spares.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[15];
			byte[] _bytes_src = value.fac_detail.getBytes();
			int _j;
			for (_j = 0; _j < 15 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[3];
			byte[] _bytes_src = value.fac_use.getBytes();
			int _j;
			for (_j = 0; _j < 3 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[10];
			byte[] _bytes_src = value.fac_group.getBytes();
			int _j;
			for (_j = 0; _j < 10 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[10];
			byte[] _bytes_src = value.comp_id.getBytes();
			int _j;
			for (_j = 0; _j < 10 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.no_of_sprs.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.no_of_wires.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.shld_dir.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.ckt_clo_scan.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.alt_pri.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.dr_class.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[3];
			byte[] _bytes_src = value.misuse.getBytes();
			int _j;
			for (_j = 0; _j < 3 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.mw.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[3];
			byte[] _bytes_src = value.termn_frames.getBytes();
			int _j;
			for (_j = 0; _j < 3 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[4];
			byte[] _bytes_src = value.seq_nbr.getBytes();
			int _j;
			for (_j = 0; _j < 4 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{ 
			for (int __i0 = 0; __i0 < 12; __i0++) { 
				com.sbc.gwsvcs.service.circuitprovisioning.interfaces.CblsGrpDefHelper.write (o, value.CblsGrp[__i0]);
			} 
		}
		{
			byte[] _bytes = new byte[81];
