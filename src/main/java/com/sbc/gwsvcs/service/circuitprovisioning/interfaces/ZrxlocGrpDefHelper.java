// $Id: ZrxlocGrpDefHelper.java,v 1.1 2002/09/29 04:10:30 dm2328 Exp $
...
public class ZrxlocGrpDefHelper { 
	private static TypeCode myTc = null;
	private ZrxlocGrpDefHelper () {
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.ZrxlocGrpDef extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/ZrxlocGrpDef:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.ZrxlocGrpDef t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.ZrxlocGrpDef read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 7; _j++)
				if (_bytes[_j] == 0)
					break;
			value.lpc = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[12];
			i.read_octet_array (_bytes, 0, 12);
			...
			for (_j = 0; _j < 12; _j++)
				if (_bytes[_j] == 0)
					break;
			value.pc_ncp = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
		...
		}
		{
			...
			for (_j = 0; _j < 6; _j++)
				if (_bytes[_j] == 0)
					break;
			value.ciccomp = new String (_bytes, 0, _j);
		}
		return value; 
	}
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[8].name = "ciccomp";
			members[8].type = ORB.init().create_array_tc (
				6, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "ZrxlocGrpDef", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.circuitprovisioning.interfaces.ZrxlocGrpDef value) { 
		{
			byte[] _bytes = new byte[2];
		...
		{
			byte[] _bytes = new byte[7];
			byte[] _bytes_src = value.lpc.getBytes();
			int _j;
			for (_j = 0; _j < 7 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[12];
			byte[] _bytes_src = value.pc_ncp.getBytes();
			int _j;
			for (_j = 0; _j < 12 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[6];
			byte[] _bytes_src = value.ciccomp.getBytes();
			int _j;
			for (_j = 0; _j < 6 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
