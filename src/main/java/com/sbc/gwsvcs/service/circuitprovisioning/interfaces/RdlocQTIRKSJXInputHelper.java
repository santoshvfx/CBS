// $Id: RdlocQTIRKSJXInputHelper.java,v 1.1 2011/04/04 13:43:24 jo8461 Exp $
//############################################################################
//#
//# Copyright Notice:
//#
...
/**
 * Class      : RdlocQTIRKSJXInputHelper
 * Description: Helper used for handling the input of the TIRKSJX RDLOC screen.
 * 
 * @author js7440
 */
public class RdlocQTIRKSJXInputHelper 
{ 
     ...
     * @author js7440
     */
	private RdlocQTIRKSJXInputHelper () 
	{
	}
	 ...
	 * @author js7440
	 */
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocQTIRKSJXInput extract (
		org.omg.CORBA.Any a) 
		throws 
			BAD_OPERATION 
	{ 
	...
	{ 
		return "IDL:com/sbc/gwsvcs/service/circuitprovisioning/interfaces/RdlocQTIRKSJXInput:1.0"; 
	}
     ...
     * 
     * @param org.omg.CORBA.Any a
     * @param com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocQTIRKSJXInput t
     * @author js7440
     */
	public static void insert (
		org.omg.CORBA.Any a, 
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocQTIRKSJXInput t) 
	{ 
     ...
     * @author js7440
     */
	public static com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocQTIRKSJXInput read (
	...
	{ 
		if (myTc == null) { 
			...
			myTc = ORB.init().create_struct_tc (id(), "RdlocQTIRKSJXInput", members); 
		}
		return myTc; 
	}
	 ...
	 * @param com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocQTIRKSJXInput value
	 * @author js7440
	 */
	public static void write (
		org.omg.CORBA.portable.OutputStream o, 
		com.sbc.gwsvcs.service.circuitprovisioning.interfaces.RdlocQTIRKSJXInput value) 
	{ 
		{
			byte[] _bytes = new byte[9];
