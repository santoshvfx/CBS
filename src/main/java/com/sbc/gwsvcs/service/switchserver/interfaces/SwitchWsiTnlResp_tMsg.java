...
public class SwitchWsiTnlResp_tMsg implements MMarshalObject { 
	public SwitchWsiTnlResp_t value;

	public SwitchWsiTnlResp_tMsg () {
	}
	public SwitchWsiTnlResp_tMsg (SwitchWsiTnlResp_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeSwitchWsiTnlResp_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeSwitchWsiTnlResp_t (ms, tag); 
	}
	static public SwitchWsiTnlResp_t decodeSwitchWsiTnlResp_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		SwitchWsiTnlResp_t value = create();
	...
	static public void encodeSwitchWsiTnlResp_t (MMarshalStrategy ms, SwitchWsiTnlResp_t value, String tag) throws MMarshalException { 
	...
	public static byte [] toOctet (SwitchWsiTnlResp_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeSwitchWsiTnlResp_t (ms, val, "SwitchWsiTnlResp_t");
	...
	public static SwitchWsiTnlResp_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeSwitchWsiTnlResp_t (ms, "SwitchWsiTnlResp_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.switchserver.interfaces.SwitchWsiTnlResp_t create () { 
