...
public class SwitchTdoResp_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private SwitchTdoResp_tHelper () {
	}
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				myTc = ORB.init().create_struct_tc (id(), "SwitchTdoResp_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com/sbc/gwsvcs/service/switchserver/interfaces/SwitchTdoResp_t:1.0"; } 
}
