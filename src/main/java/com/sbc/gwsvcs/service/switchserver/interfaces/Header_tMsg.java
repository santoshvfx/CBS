...
public class Header_tMsg implements MMarshalObject { 
	...
	static public Header_t decodeHeader_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		...
		value.TRNSPT_CD = com.sbc.gwsvcs.service.switchserver.interfaces.TrnsptType_eMsg.decodeTrnsptType_e (ms, "TRNSPT_CD");
	...
	static public void encodeHeader_t (MMarshalStrategy ms, Header_t value, String tag) throws MMarshalException { 
		...
		com.sbc.gwsvcs.service.switchserver.interfaces.TrnsptType_eMsg.encodeTrnsptType_e (ms, value.TRNSPT_CD, "TRNSPT_CD");
		ms.encode (value.RPLY_DEST, 121, "RPLY_DEST");
		ms.endStruct (tag, true); 
	}
	public TypeCode getType () { 
		return com.sbc.gwsvcs.service.switchserver.interfaces.Header_tHelper.type(); 
	}
	...
	public static com.sbc.gwsvcs.service.switchserver.interfaces.Header_t create () { 
		...
		value.TRNSPT_CD = com.sbc.gwsvcs.service.switchserver.interfaces.TrnsptType_e.RPC_TRNSPT;
