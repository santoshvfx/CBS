...
public class PreMctReq_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private PreMctReq_tHelper () {
	}
	public static com.sbc.gwsvcs.service.switchserver.interfaces.PreMctReq_t read (org.omg.CORBA.portable.InputStream i) { 
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.switchserver.interfaces.PreMctReq_t value) { 
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.switchserver.interfaces.PreMctReq_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.switchserver.interfaces.PreMctReq_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				myTc = ORB.init().create_struct_tc (id(), "PreMctReq_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com/sbc/gwsvcs/service/switchserver/interfaces/PreMctReq_t:1.0"; } 
}
