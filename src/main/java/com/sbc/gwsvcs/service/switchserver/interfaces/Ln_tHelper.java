...
public class Ln_tHelper { 
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.switchserver.interfaces.Ln_t:1.0"; }
	...
	public static TypeCode type() { 
		if (myTc == null)
		{
			...
			members[0].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.switchserver.interfaces.Ln_tHelper.id(), "Ln_t", members[0].type);
			myTc = members[0].type;
		}
		return myTc; 
	} 
