...
public class TrnsptType_eMsg implements MMarshalObject { 
	...
	static public TrnsptType_e decodeTrnsptType_e (MMarshalStrategy ms, String tag) throws MMarshalException { 
		...
		try { 
			return com.sbc.gwsvcs.service.switchserver.interfaces.TrnsptType_e.from_int (enumVal); 
		} catch (BAD_PARAM e) { 
	...
	public static com.sbc.gwsvcs.service.switchserver.interfaces.TrnsptType_e create () { 
		return com.sbc.gwsvcs.service.switchserver.interfaces.TrnsptType_e.RPC_TRNSPT; 
	} 
}
