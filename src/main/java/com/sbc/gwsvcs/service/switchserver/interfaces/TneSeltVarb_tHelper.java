...
public class TneSeltVarb_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private TneSeltVarb_tHelper () {
	}
	public static com.sbc.gwsvcs.service.switchserver.interfaces.TneSeltVarb_t read (org.omg.CORBA.portable.InputStream i) { 
		...
		value.GoodInfo = com.sbc.gwsvcs.service.switchserver.interfaces.GoodInfo_tHelper.read (i);
		return value; 
	}

	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.switchserver.interfaces.TneSeltVarb_t value) { 
		{
			byte[] _bytes = new byte[7];
		...
		com.sbc.gwsvcs.service.switchserver.interfaces.GoodInfo_tHelper.write (o, value.GoodInfo);
	}

	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.switchserver.interfaces.TneSeltVarb_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.switchserver.interfaces.TneSeltVarb_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[3].name = "GoodInfo";
				members[3].type = com.sbc.gwsvcs.service.switchserver.interfaces.GoodInfo_tHelper.type();
				myTc = ORB.init().create_struct_tc (id(), "TneSeltVarb_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com/sbc/gwsvcs/service/switchserver/interfaces/TneSeltVarb_t:1.0"; } 
}
