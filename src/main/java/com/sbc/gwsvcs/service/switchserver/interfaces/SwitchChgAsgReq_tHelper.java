...
public class SwitchChgAsgReq_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private SwitchChgAsgReq_tHelper () {
	}
	public static com.sbc.gwsvcs.service.switchserver.interfaces.SwitchChgAsgReq_t read (org.omg.CORBA.portable.InputStream i) { 
		...
		{ 
			...
			for (int __i = 0; __i < __seqLength; __i++) { 
				value.ChgAsgReq[__i] = com.sbc.gwsvcs.service.switchserver.interfaces.ChgAsgReq_tHelper.read (i);
			} 
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.USER_MODE_IND = new String (_bytes, 0, _j);
		}
		return value; 
	}

	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.switchserver.interfaces.SwitchChgAsgReq_t value) { 
		com.sbc.gwsvcs.service.switchserver.interfaces.Header_tHelper.write (o, value.Header);
		{ 
			o.write_long (value.ChgAsgReq.length);
			for (int __i = 0; __i < value.ChgAsgReq.length; __i++) { 
				com.sbc.gwsvcs.service.switchserver.interfaces.ChgAsgReq_tHelper.write (o, value.ChgAsgReq[__i]);
			} 
		}
		{
			byte[] _bytes = new byte[7];
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.USER_MODE_IND.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.switchserver.interfaces.SwitchChgAsgReq_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.switchserver.interfaces.SwitchChgAsgReq_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[1].name = "ChgAsgReq";
				members[1].type = com.sbc.gwsvcs.service.switchserver.interfaces.ChgAsgReq_tHelper.type();
				...
				members[4].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.switchserver.interfaces.UserModeInd_tHelper.id(), "UserModeInd_t", members[4].type);
				myTc = ORB.init().create_struct_tc (id(), "SwitchChgAsgReq_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com/sbc/gwsvcs/service/switchserver/interfaces/SwitchChgAsgReq_t:1.0"; } 
}
