...
public class EPAF_Section_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private EPAF_Section_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.EPAF_Section_t read (org.omg.CORBA.portable.InputStream i) { 
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.EPAF_Section_t value) { 
		{
			byte[] _bytes = new byte[5];
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.EPAF_Section_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.EPAF_Section_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				__active = true;
				StructMember members[] = new StructMember[51];
				...
				members[12].type = ORB.init().create_array_tc (33, members[12].type);
				members[13] = new StructMember();
				members[13].name = "STATE";
				...
				members[17].name = "STEA";
				members[17].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[17].type = ORB.init().create_array_tc (51, members[17].type);
				members[18] = new StructMember();
				members[18].name = "LRST";
				...
				members[24].name = "USOC";
				members[24].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[24].type = ORB.init().create_array_tc (6, members[24].type);
				...
				members[28].type = ORB.init().create_array_tc (2, members[28].type);
				...
				members[38].type = ORB.init().create_array_tc (3, members[38].type);
				members[39] = new StructMember();
				members[39].name = "OWS";
				members[39].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[39].type = ORB.init().create_array_tc (2, members[39].type);
				...
				members[44].type = ORB.init().create_array_tc (13, members[44].type);
				members[45] = new StructMember();
				members[45].name = "POS";
				members[45].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[45].type = ORB.init().create_array_tc (6, members[45].type);
				members[46] = new StructMember();
				members[46].name = "JACK";
				...
				members[47].type = ORB.init().create_array_tc (5, members[47].type);
				members[48] = new StructMember();
				members[48].name = "LSEG";
				members[48].type = com.sbc.gwsvcs.service.facsaccess.interfaces.LSEG_tHelper.type();
				members[48].type = ORB.init().create_sequence_tc (0, members[48].type);
				members[49] = new StructMember();
				members[49].name = "EPOEC";
				members[49].type = com.sbc.gwsvcs.service.facsaccess.interfaces.EPOEC_tHelper.type();
				members[49].type = ORB.init().create_sequence_tc (0, members[49].type);
				members[50] = new StructMember();
				members[50].name = "EAPNT";
				members[50].type = com.sbc.gwsvcs.service.facsaccess.interfaces.EAPNT_tHelper.type();
				members[50].type = ORB.init().create_sequence_tc (0, members[50].type);
				myTc = ORB.init().create_struct_tc (id(), "EPAF_Section_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/EPAF_Section_t:1.0"; } 
}
