...
public class ATTRNG_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private ATTRNG_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t value = new com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t();
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.CODE = new String (_bytes, 0, _j);
		}
		{
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t value) { 
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.CODE.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[5].type = ORB.init().create_array_tc (21, members[5].type);
				myTc = ORB.init().create_struct_tc (id(), "ATTRNG_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/ATTRNG_t:1.0"; } 
}
