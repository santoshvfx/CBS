...
public class OEC_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private OEC_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.OEC_t read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.facsaccess.interfaces.OEC_t value = new com.sbc.gwsvcs.service.facsaccess.interfaces.OEC_t();
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.GRD = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.CLS = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
		...
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.NLI = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.MI = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.CTG = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.COTE = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
		...
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.SIG = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.MET = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[2];
			i.read_octet_array (_bytes, 0, 2);
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.OEC_t value) { 
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.GRD.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.CLS.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.NLI.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.MI.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.CTG.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.COTE.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.SIG.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.MET.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.OEC_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.OEC_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				myTc = ORB.init().create_struct_tc (id(), "OEC_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/OEC_t:1.0"; } 
}
