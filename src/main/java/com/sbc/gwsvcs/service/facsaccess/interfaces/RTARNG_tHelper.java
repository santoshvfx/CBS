...
public class RTARNG_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private RTARNG_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_t read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_t value = new com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_t();
		{
			...
			for (_j = 0; _j < 3; _j++)
				if (_bytes[_j] == 0)
					break;
			value.RTANO = new String (_bytes, 0, _j);
		}
		{
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_t value) { 
		{
			byte[] _bytes = new byte[3];
			byte[] _bytes_src = value.RTANO.getBytes();
			int _j;
			for (_j = 0; _j < 3 - 1; _j++)
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				myTc = ORB.init().create_struct_tc (id(), "RTARNG_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/RTARNG_t:1.0"; } 
}
