...
public class THASG_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private THASG_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.THASG_t read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FCA = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FLPR = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FHPR = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TCA = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TLPR = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.THPR = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FCA2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FLPR2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FHPR2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TCA2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TLPR2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.THPR2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FCA3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FLPR3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FHPR3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TCA3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TLPR3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.THPR3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FCA4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FLPR4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FHPR4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TCA4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TLPR4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.THPR4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FCA5 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FLPR5 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FHPR5 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TCA5 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TLPR5 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.THPR5 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FCA6 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FLPR6 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.FHPR6 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TCA6 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.TLPR6 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.THPR6 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[9];
			i.read_octet_array (_bytes, 0, 9);
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.THASG_t value) { 
		{
			byte[] _bytes = new byte[7];
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.FCA.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FLPR.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FHPR.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.TCA.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.TLPR.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.THPR.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.FCA2.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FLPR2.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FHPR2.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.TCA2.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.TLPR2.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.THPR2.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.FCA3.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FLPR3.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FHPR3.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.TCA3.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.TLPR3.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.THPR3.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.FCA4.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FLPR4.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FHPR4.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.TCA4.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.TLPR4.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.THPR4.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.FCA5.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FLPR5.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FHPR5.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.TCA5.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.TLPR5.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.THPR5.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.FCA6.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FLPR6.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.FHPR6.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.TCA6.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.TLPR6.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.THPR6.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.THASG_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.THASG_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				__active = true;
				StructMember members[] = new StructMember[45];
				...
				members[6].type = ORB.init().create_array_tc (4, members[6].type);
				...
				members[10].type = ORB.init().create_array_tc (11, members[10].type);
				members[11] = new StructMember();
				members[11].name = "TLPR";
				...
				members[19].name = "FCA3";
				members[19].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[19].type = ORB.init().create_array_tc (11, members[19].type);
				members[20] = new StructMember();
				members[20].name = "FLPR3";
				...
				members[22].name = "TCA3";
				members[22].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[22].type = ORB.init().create_array_tc (11, members[22].type);
				members[23] = new StructMember();
				members[23].name = "TLPR3";
				...
				members[25].name = "FCA4";
				members[25].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[25].type = ORB.init().create_array_tc (11, members[25].type);
				members[26] = new StructMember();
				members[26].name = "FLPR4";
				...
				members[28].name = "TCA4";
				members[28].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[28].type = ORB.init().create_array_tc (11, members[28].type);
				members[29] = new StructMember();
				members[29].name = "TLPR4";
				...
				members[43].name = "DEST";
				members[43].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[43].type = ORB.init().create_array_tc (9, members[43].type);
				members[44] = new StructMember();
				members[44].name = "INFO";
				members[44].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[44].type = ORB.init().create_array_tc (79, members[44].type);
				myTc = ORB.init().create_struct_tc (id(), "THASG_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/THASG_t:1.0"; } 
}
