...
public class Loop_Add_Req_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private Loop_Add_Req_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t read (org.omg.CORBA.portable.InputStream i) { 
		com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t value = new com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t();
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t value) { 
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[3].name = "EPAF";
				members[3].type = com.sbc.gwsvcs.service.facsaccess.interfaces.EPAF_Section_tHelper.type();
				myTc = ORB.init().create_struct_tc (id(), "Loop_Add_Req_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/Loop_Add_Req_t:1.0"; } 
}
