...
public class ECCABLE_Section_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private ECCABLE_Section_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.ECCABLE_Section_t read (org.omg.CORBA.portable.InputStream i) { 
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.ECCABLE_Section_t value) { 
		{
			byte[] _bytes = new byte[5];
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.ECCABLE_Section_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.ECCABLE_Section_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[5].name = "RULES";
				members[5].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[5].type = ORB.init().create_array_tc (14, members[5].type);
				...
				members[8].name = "CARNG";
				members[8].type = com.sbc.gwsvcs.service.facsaccess.interfaces.CARNG_tHelper.type();
				members[8].type = ORB.init().create_sequence_tc (0, members[8].type);
				members[9] = new StructMember();
				members[9].name = "RTARNG";
				members[9].type = com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_tHelper.type();
				members[9].type = ORB.init().create_sequence_tc (0, members[9].type);
				myTc = ORB.init().create_struct_tc (id(), "ECCABLE_Section_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/ECCABLE_Section_t:1.0"; } 
}
