...
public class EPTERM_Section_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private EPTERM_Section_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.EPTERM_Section_t read (org.omg.CORBA.portable.InputStream i) { 
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.EPTERM_Section_t value) { 
		{
			byte[] _bytes = new byte[5];
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.EPTERM_Section_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.EPTERM_Section_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				__active = true;
				StructMember members[] = new StructMember[33];
				...
				members[8].type = ORB.init().create_array_tc (3, members[8].type);
				...
				members[11].type = ORB.init().create_array_tc (7, members[11].type);
				...
				members[14].type = ORB.init().create_array_tc (8, members[14].type);
				members[15] = new StructMember();
				members[15].name = "SWRVW";
				...
				members[16].type = ORB.init().create_array_tc (21, members[16].type);
				members[17] = new StructMember();
				members[17].name = "XRST";
				members[17].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[17].type = ORB.init().create_array_tc (21, members[17].type);
				members[18] = new StructMember();
				members[18].name = "PC";
				members[18].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[18].type = ORB.init().create_array_tc (5, members[18].type);
				...
				members[25].type = ORB.init().create_array_tc (51, members[25].type);
				members[26] = new StructMember();
				members[26].name = "RLC";
				members[26].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[26].type = ORB.init().create_array_tc (12, members[26].type);
				members[27] = new StructMember();
				members[27].name = "LOTI";
				members[27].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[27].type = ORB.init().create_array_tc (3, members[27].type);
				members[28] = new StructMember();
				members[28].name = "INRNG";
				members[28].type = com.sbc.gwsvcs.service.facsaccess.interfaces.INRNG_tHelper.type();
				members[28].type = ORB.init().create_sequence_tc (0, members[28].type);
				members[29] = new StructMember();
				members[29].name = "OUTRNG";
				members[29].type = com.sbc.gwsvcs.service.facsaccess.interfaces.OUTRNG_tHelper.type();
				members[29].type = ORB.init().create_sequence_tc (0, members[29].type);
				members[30] = new StructMember();
				members[30].name = "ATTRNG";
				members[30].type = com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_tHelper.type();
				members[30].type = ORB.init().create_sequence_tc (0, members[30].type);
				members[31] = new StructMember();
				members[31].name = "OCDAT";
				members[31].type = com.sbc.gwsvcs.service.facsaccess.interfaces.OCDAT_tHelper.type();
				members[31].type = ORB.init().create_sequence_tc (0, members[31].type);
				members[32] = new StructMember();
				members[32].name = "RTARNG";
				members[32].type = com.sbc.gwsvcs.service.facsaccess.interfaces.RTARNG_tHelper.type();
				members[32].type = ORB.init().create_sequence_tc (0, members[32].type);
				myTc = ORB.init().create_struct_tc (id(), "EPTERM_Section_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/EPTERM_Section_t:1.0"; } 
}
