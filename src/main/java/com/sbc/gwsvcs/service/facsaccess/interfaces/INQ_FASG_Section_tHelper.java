...
public class INQ_FASG_Section_tHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private INQ_FASG_Section_tHelper () {
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.INQ_FASG_Section_t read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.UID = new String (_bytes, 0, _j);
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.UTYP = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.EID = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[5];
			i.read_octet_array (_bytes, 0, 5);
		...
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.STYP = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 2; _j++)
				if (_bytes[_j] == 0)
					break;
			value.PND = new String (_bytes, 0, _j);
		}
		{
		...
		}
		{
			...
			for (_j = 0; _j < 5; _j++)
				if (_bytes[_j] == 0)
					break;
			value.ASGBP = new String (_bytes, 0, _j);
		}
		return value; 
	}

	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.facsaccess.interfaces.INQ_FASG_Section_t value) { 
		{
			byte[] _bytes = new byte[8];
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.UID.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.UTYP.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.EID.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.STYP.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[2];
			byte[] _bytes_src = value.PND.getBytes();
			int _j;
			for (_j = 0; _j < 2 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[5];
			byte[] _bytes_src = value.ASGBP.getBytes();
			int _j;
			for (_j = 0; _j < 5 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.facsaccess.interfaces.INQ_FASG_Section_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.facsaccess.interfaces.INQ_FASG_Section_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[1].type = ORB.init().create_array_tc (14, members[1].type);
				...
				members[9].type = ORB.init().create_array_tc (33, members[9].type);
				...
				members[16].type = ORB.init().create_array_tc (13, members[16].type);
				members[17] = new StructMember();
				members[17].name = "POS";
				members[17].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[17].type = ORB.init().create_array_tc (6, members[17].type);
				members[18] = new StructMember();
				members[18].name = "JACK";
				...
				myTc = ORB.init().create_struct_tc (id(), "INQ_FASG_Section_t", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.facsaccess.interfaces/INQ_FASG_Section_t:1.0"; } 
}
